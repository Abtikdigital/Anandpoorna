...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row px-4 sm:px-6 lg:px-12 py-6 sm:py-8 lg:py-10 bg-[#FDF8EE] min-h-[400px] md:min-h-[500px]">
      <div className="w-full md:w-1/2 flex flex-col justify-center space-y-4 sm:space-y-6 mb-6 md:mb-0">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight text-[#333]">
